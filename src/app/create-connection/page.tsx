                                                ...
                                                <FormItem className="space-y-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>
                                                                <p>Choose 'Give' to send data to Impact.com (e.g., transactions),<br /> or 'Receive' to get data from Impact.com (e.g., reports).</p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <FormDescription>
                                                ...
                                                <FormItem className="space-y-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>
                                                                <p>Select the protocol. SFTP is secure and recommended.<br />SMTP sends data via email.</p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <FormDescription>
                                                ...
                                                <FormItem className="space-y-3">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <Tooltip>
                                                            ...
                                                            <TooltipContent>
                                                                <p>'Push': Impact sends data to your server.<br />'Pull': You fetch data from Impact's server.</p>
                                                            </TooltipContent>
                                                        </Tooltip>
                                                    </div>
                                                    <FormDescription>
